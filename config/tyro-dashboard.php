    ...
    */
    ...
    'resources' => [
        ...
        'posts' => [
            ...
            'list_columns' => ['title', 'brand_id', 'status', 'created_by', 'created_at'],
            ...
            'actions' => [
                'submit_for_approval' => [
                    ...
                    'url' => fn($post) => route('dashboard.posts.submit-for-approval', $post),
                    'method' => 'POST',
                    'confirm' => 'Submit this post for approval?',
                    'visible' => fn($post) => $post->status === 'draft',
                    'class' => 'btn-primary',
                ],
                'approve' => [
                    'label' => 'Approve',
                    ...
                    'url' => fn($post) => route('dashboard.posts.approve', $post),
                    'method' => 'POST',
                    'confirm' => 'Approve this post?',
                    'visible' => fn($post) => $post->status === 'pending',
                    'class' => 'btn-success',
                ],
                'reject' => [
                    'label' => 'Reject',
                    ...
                    'url' => fn($post) => route('dashboard.posts.reject', $post),
                    'method' => 'POST',
                ...
                'view_comments' => [
                    ...
                    'url' => fn($post) => route('dashboard.posts.comments', $post),
                    'method' => 'GET',
                    'visible' => fn($post) => true,
                    'class' => 'btn-secondary',
                ],
            ],
        ],
